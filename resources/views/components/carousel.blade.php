    ...
    <div id="carouselExampleIndicators" class="carousel slide mb-8" data-bs-ride="carousel">
        ...
        <div class="carousel-inner rounded-lg">
            <div class="carousel-item active">
                <img src="{{ asset('images/carousel/event-banner-1.jpg') }}" class="d-block w-100" alt="Event Banner 1">
                <div class="carousel-caption">
                    <h2 class="text-shadow">Temukan Event Menarik</h2>
                    <p class="text-shadow">Berbagai event seru menanti Anda</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/carousel/event-banner-2.jpg') }}" class="d-block w-100" alt="Event Banner 2">
                <div class="carousel-caption">
                    <h2 class="text-shadow">Konser & Festival</h2>
                    <p class="text-shadow">Nikmati pengalaman musik terbaik</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/carousel/event-banner-3.jpg') }}" class="d-block w-100" alt="Event Banner 3">
                <div class="carousel-caption">
                    <h2 class="text-shadow">Pesan Tiket Sekarang</h2>
